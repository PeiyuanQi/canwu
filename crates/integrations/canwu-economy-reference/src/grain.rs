...
use canwu_resource::{
    ...
    ResourceDemandObservationV1, ResourceDemandSourcePolicyV1, ResourceError,
    ResourceFulfillmentObservationV1, ResourceLimitsV1, ResourceObservationHeadId,
    ResourceObservationHeadV1, ResourceOperationKey, ResourceOperationOutcomeVersionV1,
    ResourceOperationRequestV1, ResourceOperationStatus, ResourcePlugin, ResourceQualityId,
    ResourceReportGrantId, ResourceReportGrantV1, ResourceRevision, ResourceScopeId, ResourceState,
    ResourceStockObservationV1, ResourceSubmitDemandRequestV1, ResourceTieBreakKey,
    ResourceTransferDispositionRequestV1, ResourceTransferDispositionV1, ResourceTransferId,
    ResourceTransferObservationV1, ResourceTransferProgressRequestV1,
    ResourceTransferStartRequestV1, ResourceTransportAcceptanceV1, ResourceUnitRevision,
    RunBudgetRevisionV1, TransferProgressV1, TransportExecutionLink,
    enqueue_resource_adapter_operation, enqueue_resource_allocation, enqueue_resource_archive,
    enqueue_resource_completion_operation, finalize_resource_archive_retention, resource_command,
    resource_operation_outcome, resource_state,
};
